...
enum POPUPFLAGS { PWF_VISIBLE = 0x00000001,
...
enum ACTUATEFLAGS { ACF_LEFT = 0x00000001,
...
// Public Interface to a simulator component _instance.
class IINSTANCE {
public:
...
// Simulator Modes
enum DSIMMODES { DSIMBOOT = 0x01,
                 DSIMSETTLE = 0x02,
                 DSIMNORMAL = 0x04,
                 DSIMEND = 0x08
};

enum DSIMVARS { DSIMTIMENOW = -1,
                DSIMTDSCALE
};
...
// Interface to a digital component _instance.
class IDSIMCKT {
public:
#ifdef __SC__
...
enum ACTIVEDATATYPES { ADT_VOID = -1,
                       ADT_REAL,
                       ADT_BOOLEAN,
                       ADT_INTEGER,
                       ADT_STATE,
